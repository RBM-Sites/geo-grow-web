...
const HomePage = () => {
  return (
    <>
      ...
      <main>
        {/* Hero */}
        <section className="relative min-h-[70vh] flex items-center pt-24 md:pt-28" style={{ backgroundImage: "url(/media/hero-homepage-plumbing-hvac-las-vegas.jpg)", backgroundSize: "cover", backgroundPosition: "center" }}>
