...
const SERVICE_IMAGES: Record<string, { src: string; alt: string }> = {
  ...
  "sewer-line-repair": { src: "/media/service-sewer-line-replacement-las-vegas.jpg", alt: "Sewer line repair and diagnostics for a Las Vegas property" },
  ...
  "toilet-installation": { src: "/media/service-toilet-repair-installation-las-vegas.jpg", alt: "New toilet installation with wax ring seal in a Las Vegas bathroom" },
  ...
  "ac-replacement": { src: "/media/service-ac-replacement-las-vegas.jpg", alt: "AC replacement with energy-efficient condenser on concrete pad in Las Vegas, NV" },
  "air-conditioner-replacement": { src: "/media/service-ac-replacement-las-vegas.jpg", alt: "Air conditioner replacement service for a Las Vegas desert home" },
  ...
  "air-conditioning-system-installation": { src: "/media/service-central-ac-installation-las-vegas.jpg", alt: "Complete air conditioning system installation in Las Vegas, NV" },
  ...
  "ac-not-cooling-repair": { src: "/media/service-ac-not-cooling-repair-las-vegas.jpg", alt: "Diagnosing AC not cooling with refrigerant gauges at a Las Vegas residence" },
  ...
  "ac-refrigerant-recharge": { src: "/media/service-ac-not-cooling-repair-las-vegas.jpg", alt: "AC refrigerant recharge with manifold gauges in Las Vegas, NV" },
  "ac-leak-repair": { src: "/media/service-ac-repair-technician-las-vegas.jpg", alt: "AC leak repair and detection in Las Vegas, NV" },
  "ac-compressor-repair": { src: "/media/service-ac-compressor-repair-las-vegas.jpg", alt: "AC compressor repair with service panel open in Las Vegas, NV" },
  ...
  "ductwork-repair": { src: "/media/service-ductwork-installation-las-vegas.jpg", alt: "Ductwork repair to restore HVAC efficiency in a Las Vegas home" },
  ...
  "heat-pump-repair": { src: "/media/service-heat-pump-las-vegas.jpg", alt: "Heat pump outdoor unit repair for year-round comfort in Las Vegas, NV" },
  ...
  "heat-pump-installation": { src: "/media/service-heat-pump-las-vegas.jpg", alt: "Heat pump installation with refrigerant lines at a Las Vegas residence" },
  "boiler-installation": { src: "/media/service-boiler-las-vegas.jpg", alt: "Boiler installation with copper piping and expansion tank in Las Vegas, NV" },
  "boiler-replacement": { src: "/media/service-boiler-las-vegas.jpg", alt: "Boiler replacement upgrade for a Las Vegas property" },
  ...
  "hvac-maintenance": { src: "/media/service-hvac-tune-up-las-vegas.jpg", alt: "Comprehensive HVAC maintenance for Las Vegas homeowners" },
  "hvac-inspection": { src: "/media/service-ac-not-cooling-repair-las-vegas.jpg", alt: "HVAC system inspection with diagnostic gauges in Las Vegas, NV" },
  ...
  "whole-house-dehumidifier-installation": { src: "/media/service-humidifier-installation-las-vegas.jpg", alt: "Whole house dehumidifier installation for Las Vegas homes" },
  ...
  "air-scrubber-installation": { src: "/media/service-uv-air-purifier-las-vegas.jpg", alt: "Air scrubber installation for improved indoor air quality in Las Vegas, NV" },
  ...
  "rooftop-unit-installation": { src: "/media/service-commercial-hvac-repair-las-vegas.jpg", alt: "Rooftop HVAC unit installation on a Las Vegas commercial building" },
  ...
  "make-up-air-unit-installation": { src: "/media/service-commercial-ventilation-las-vegas.jpg", alt: "Make-up air unit and kitchen ventilation in a Las Vegas restaurant" },
  "exhaust-fan-installation": { src: "/media/service-commercial-ventilation-las-vegas.jpg", alt: "Commercial exhaust fan and ventilation installation in Las Vegas, NV" },
};
