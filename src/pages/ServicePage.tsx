...
const SERVICE_IMAGES: Record<string, { src: string; alt: string }> = {
  ...
  "tankless-water-heater": { src: "/media/service-tankless-water-heater-las-vegas.jpg", alt: "Wall-mounted tankless water heater with copper supply lines in a Las Vegas home" },
  "whole-house-water-filtration": { src: "/media/service-whole-house-water-filtration-las-vegas.jpg", alt: "Whole house water filtration and softener system installed at a Las Vegas residence" },
      ...
      },
      {
        ...
        body: (
          <>
            ...
            <p>We help homeowners decide between traditional tank and <Link to="/plumber/tankless-water-heater" className="text-secondary font-semibold hover:underline">tankless water heater</Link> options based on household size, hot-water demand, and long-term energy savings. We also install <Link to="/plumber/whole-house-water-filtration" className="text-secondary font-semibold hover:underline">whole house water filtration</Link> systems to protect every fixture from the calcium, chlorine, and scale typical of Las Vegas water. Every installation includes proper permitting through the City of Las Vegas or the relevant jurisdiction, code-compliant connections, and old-unit disposal.</p>
            <p>Beyond water heaters, our plumbing team tackles <Link to="/plumber/leak-detection" className="text-secondary font-semibold hover:underline">leak detection</Link>, <Link to="/plumber/sewer-line-repair" className="text-secondary font-semibold hover:underline">sewer line repair</Link>, <Link to="/plumber/toilet-repair" className="text-secondary font-semibold hover:underline">toilet repair</Link>, and <Link to="/plumber/faucet-installation" className="text-secondary font-semibold hover:underline">faucet installation</Link> — quick fixes and full upgrades that keep your Las Vegas home running smoothly.</p>
